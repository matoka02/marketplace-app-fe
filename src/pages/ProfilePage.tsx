        ...
        <div className="border-t border-gray-200 ">
          <dl>
            <div className="py-3">
              ...
              <dd className="mt-1 text-sm text-primary">John Doe</dd>
            </div>
            <div className="py-3 ">
              <dt className="text-sm font-medium text-secondary">
                Email address
              </dt>
              <dd className="mt-1 text-sm text-primary">johndoe@example.com</dd>
            </div>
            <div className="py-3">
              <dt className="text-sm font-medium text-secondary">
                Phone number
              </dt>
              <dd className="mt-1 text-sm text-primary">(123) 456-7890</dd>
            </div>
            <div className="py-3">
